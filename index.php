...
?>
		...
		<div class="main-body-text" id="top">
			...
			<div id="about-us-content">
				<img style="float:left;" src="resources/tec_logo.svg" alt="us" height="200px" width="relative" >
...
<?php $mail=mail( "nathansd1098@gmail.com" , "hallo", "oh hia", "From: nathan@team3389.info", "-f nathan@team3389.info" );
		echo $mail;
?>
