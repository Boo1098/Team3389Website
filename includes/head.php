...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<link rel="stylesheet" type="text/css" href="http://nathan.team3389.info/Stylesheets/light.css" />
	<?php
	session_start();
	/*if (isset($_SESSION["theme"])) {
	...
	<?php $useragent=$_SERVER['HTTP_USER_AGENT'];
		...
		echo ('<link rel="stylesheet" type="text/css" href="http://nathan.team3389.info/Stylesheets/stylesheet-mobile.css">');
	?>
	</head>
	<body>
