	<footer>
		...
		<div id="footer-div">
			...
			<table style="margin-top:20px;width:98%;table-layout:fixed">
				<tr style="height:10%">
					<td  align="left" height="10%" valign="left"><a href="http://usfirst.org"><img align="left" src="resources/first.png" alt="First"height="auto" width="auto"class="hvr-skew-backward"></a></td>
					<td align="center" height="10%" valign="center"><a href="http://tecfound.org"><img src="resources/tecfound.png" alt="Tec Foundation"height="auto" width="auto"class="hvr-bounce-in"></a></td>
					<td align="right" height="10%" valign="right"><a href="http://usfirst.org/frc"><img align="right"src="resources/frc.gif" alt="FIRST Robotics Competition"height="auto" width="auto" class="hvr-skew-forward"></a></td>
				</tr>
				<tr> 
