		...
		<div id="footer-div">
			...
			<table width="97%"> 
				<tr style="white-space:no-wrap;width:98%"> 
					...
					<td valign="middle" class="link-row" align="right" width="100%"><a href="https://twitter.com/FRCTeam3389" class="twitter-follow-button"  target="_blank" data-show-count="false" style="padding-top:8px;">Follow @FRCTeam3389</a> <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
			...
			<div style="background-color:#3A3A3A;align:center;">
					...
					<td>
						<a href="http://usfirst.org">
							<img align="left" src="resources/first.png" style="align:left" alt="First"height="100px" target="_blank" width="auto" class="hvr-skew-backward">
						</a>
					</td>
					<td valign="center">
