	<footer>
		<div id="footer-div">
			...
			<div style="background-color:#3A3A3A;align:center;">
					...
					<p style="padding-top:10px;padding-left:5px;margin:0px;float:left;"align="left"><a style="margin:0px;" href="http://github.com/boo1098/nathan" class="hvr-buzz">Fork me on gihub!</a></p>
