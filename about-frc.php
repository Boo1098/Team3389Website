...
?>
		...
		<div class="main-body-text" id="top">
			<h2 class="body-header font-effect-3d-float">About <em>FIRST</em><sup>&reg;</sup> Robotics competition</h2>
			
			<br />
			<div id="about-us-content">
				<img style="float:left;padding:20px;" src="http://team3389.info/resources/FIRST/Programs/IconVertical/RGB/Reverse/FIRSTRobotics_IconVert_RGB_reverse.png" class="full_mobile" alt="frc" height="200" />
				
				<!-- THANKS for writing this ALEX  -->
				
				<div class="text">
					<p><a class="body-link" href="http://www.usfirst.org/roboticsprograms/frc"><em>FIRST</em><sup>&reg;</sup> Robotics Competition (FRC)</a> is an international high school robotics competition. Each year, teams of high school students and mentors work during a six-week period to build game-playing robots that weigh up to 120 pounds (54 kg). Robots complete tasks such as scoring balls into goals, Frisbees into goals, inner tubes onto racks, hanging on bars, and balancing robots on balance beams, for example this year's "challenge" was <a class="body-link" href="https://www.youtube.com/watch?v=W6UYFKNGHJ8">Recycle Rush</a>. The game changes yearly, keeping the excitement fresh and giving each team a more level playing field. While teams are given a standard set of parts, they are also allowed a budget and encouraged to buy or make specialized parts. FRC is one of four robotics competition programs organized by <em>FIRST</em>.</p>
