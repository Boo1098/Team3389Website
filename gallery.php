	...
	<div class="main-body-text" height="400" id="top">
		...
		<div id="about-us-content" height="200 "align="center">
			<?php
				...
				{
					$num = $files[$i];
					echo '<a href="'.'http://www.team3389.info/old_site/img2/galleries/2010-Chesapeake_Regional/'.substr($num,75).'"><img src="'.'http://'.substr($num,6).'" alt="'.substr($num,75,-4).'" style="float:left;" /></a>'."<br><br>";
				}
			?>
		</div>
	</div>
